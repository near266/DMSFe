...
export class EmployeeService {
    ...
    ArchiveEmployee(body: any): Observable<any> {
        return this.http.post(gateway_url + '/Employee/ArchivedEmployee', body).pipe(map((response: any) => response));
    }

    DisableEmployee(body: any): Observable<any> {
        return this.http.post(gateway_url + '/Employee/DisableEmployee', body).pipe(map((response: any) => response));
    }
    ...
    GetChildrenByParentId(parentNodeId: any): Observable<any> {
        return this.http
            .get(gateway_url + '/GetChildrenByParentId?ParentNodeId=' + parentNodeId)
            .pipe(map((response: any) => response));
    }
    ...
    GetAllEmployeeByManager(page: number, pageSize: number): Observable<any> {
        return this.http
            .get(gateway_url + '/Employee/GetAllEmployeeByManagaer?page=' + page + '&pagesize=' + pageSize)
            .pipe(map((response: any) => response));
    }
    ...
    GetAllEmployeeByTitle(title: any, page: number, pageSize: number): Observable<any> {
        return this.http
            .get(
                gateway_url +
                    '/Employee/GetAllEmployeeByTitle?title=' +
                    title +
                    '&page=' +
                    page +
                    '&pagesize=' +
    ...
    DeleteEmployeeUnitTree(EmployeeId: any, UnitTreeGroupId: any): Observable<any> {
        return this.http
            .delete(
                gateway_url +
                    '/DeleteEmployeeUnitTree?EmployeeId=' +
                    EmployeeId +
                    '&UnitTreeGroupId=' +
                    UnitTreeGroupId,
            )
    ...
    GetEmployeeInGroup(body: any): Observable<any> {
        return this.http.post(gateway_url + '/SearchEmployeeInGroupPost', body).pipe(map((response: any) => response));
    }
