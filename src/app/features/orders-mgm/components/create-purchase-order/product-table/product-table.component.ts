import { Component, OnInit, AfterViewInit, DoCheck, EventEmitter, Input, Output } from '@angular/core';
...
export class ProductTableComponent implements OnInit, AfterViewInit, DoCheck {
